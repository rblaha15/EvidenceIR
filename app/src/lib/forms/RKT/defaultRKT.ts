...
export default (y: number, done: number[]): FormPlus<FormRKT> => ({
    ...
    kontrolaOtopneSoustavy: {
        ...
        _kontrolaTlakuVOtopneSoustaveNadpis: newTextWidget({ text: t => t.rkt.kontrolaTlakuVOtopneSoustave, class: 'text-lg' }),
    ...
    kontrolaTlakuExpanznichNadob: {
        ...
        _expanzniNadobaOtopneSoustavyNadpis: newTextWidget({ text: t => t.rkt.expanzniNadobaOtopneSoustavy, class: 'text-lg' }),
        ...
        _expanzniNadobaPitneVodyNadpis: newTextWidget({ text: t => t.rkt.expanzniNadobaPitneVody, class: 'text-lg' }),
