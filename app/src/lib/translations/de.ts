...
const de: PlainTranslations = {
    ...
    in: {
        remoteAccess: {
            ...
            alreadyIsConnected: 'Der Regler ist bereits mit dem RegulusRoute-Dienst verbunden.',
        },
...
<p>Regulus SEIR-Team</p>`,
        ...
        invalidEmailOrPassword: 'Falsche E-Mail-Adresse oder falsches Passwort!',
        signUpEmailSent: 'Sie haben eine E-Mail mit einem Link zur Vervollständigung Ihrer Registrierung erhalten. Sie können dieses Fenster jetzt schließen.',
        currentPassword: 'Aktuelles Passwort',
        youAreOffline: 'Sie sind offline. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut.',
    },
    detail: {
        ...
        movedIR: `Dieses Installationsprotokoll wurde an`,
        newAddress: `eine neue Adresse`,
        movedIRend: ` verschoben.`,
        ...
        finishRecord: 'Protokoll abschließen',
    ...
    tc: {
        ...
        shortTitle: 'Protokoll zur IBN der WP',
    ...
    widget: {
        ...
        scanBarcode: `Scanne den Barcode von WP`,
        yes: 'ja',
        no: 'nein',
    ...
    search: {
        ...
        title: 'Installationsliste',
        whatToSearch: 'Suche nach Benutzername, Gemeinde, Seriennummer oder Typ des Reglers'
    },
    sol: {
        ...en.sol,
    ...
    od: {
        ...
        info2B: t`die Montagefirma unter ${'assembly'}`,
        info2C: t`unter ${'ccs'}`,
        info2D: t`Sie unter ${'user'}`,
        and: ` und `,
        info3: ` abgesendet.`,
