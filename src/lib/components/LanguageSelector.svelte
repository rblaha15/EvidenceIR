...
<div class="dropdown">
	<button type="button" class="btn dropdown-toggle align-items-center d-flex" data-bs-toggle="dropdown">
		<svg
		...
		<span class="fs-5 mx-1">{$page.data.languageCode.toUpperCase()}</span>
	</button>
