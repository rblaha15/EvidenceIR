...
const pdfFT: GetPdfData<'FT'> = async ({ data: { faceTable, evidence: e }, t }) => {
    ...
    return {
        ...
        'Dropdown1.8.0.0': t.get(f.inputsC.moduleUNI_1),
        'Dropdown1.8.0.1': t.get(f.inputsC.moduleUNI_2),
        'Dropdown1.8.1.0': t.get(f.inputsC.moduleUNI2_1),
        'Dropdown1.8.1.1': t.get(f.inputsC.moduleUNI2_2),
        ...
        'Dropdown3.5.0.0': t.get(f.outputsF.moduleUNI_DO1),
        'Dropdown3.5.0.1': t.get(f.outputsF.moduleUNI_DO2),
        'Dropdown3.5.1.0': t.get(f.outputsF.moduleUNI2_DO1),
        'Dropdown3.5.1.1': t.get(f.outputsF.moduleUNI2_DO2),
        'Dropdown4.0': t.get(f.outputsB.B2),
        'Dropdown4.1': t.get(f.outputsB.B3),
        'Dropdown4.2': t.get(f.outputsB.moduleUNI_AO1),
        'Dropdown4.3': t.get(f.outputsB.moduleUNI2_AO1),
