...
const infoRKT: FormInfo<DataRKTL, FormRKTL, [], 'RKTL', { defaultYear: Year, filledYears: Year[], pump: TC }> = {
    ...
    getEditData: (ir, url, { pump }) => {
        ...
        if (edit) return { raw: ir.kontrolyTC[pump]![edit] as Raw<FormRKTL>, other: { defaultYear: edit } };
    },
    getViewData: (ir, url) => {
        ...
        if (view) return { raw: ir.kontrolyTC[pump]![view] as Raw<FormRKTL>, other: { defaultYear: view, filledYears, pump } };
    },
