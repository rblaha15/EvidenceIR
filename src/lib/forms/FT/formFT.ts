...
export interface FormFT extends Form<DataFT> {
    inputsC: {
        ...
        C8: WidgetInputC,
        C9: WidgetInputC,
        moduleUNI_label: TextWidget<DataFT>,
        moduleUNI_1: WidgetInputC,
        moduleUNI_2: WidgetInputC,
        moduleUNI2_label: TextWidget<DataFT>,
        moduleUNI2_1: WidgetInputC,
        moduleUNI2_2: WidgetInputC,
    },
    inputsB: {
        title: TitleWidget<DataFT>,
        B8: WidgetInputB,
    ...
    outputsF: {
        ...
        F6: WidgetOutputF,
        moduleUNI_label: TextWidget<DataFT>,
        moduleUNI_DO1: WidgetOutputF,
        moduleUNI_DO2: WidgetOutputF,
        moduleUNI2_label: TextWidget<DataFT>,
        moduleUNI2_DO1: WidgetOutputF,
        moduleUNI2_DO2: WidgetOutputF,
    },
    outputsB: {
        title: TitleWidget<DataFT>,
        B2: WidgetOutputB,
        B3: WidgetOutputB,
        moduleUNI_label: TextWidget<DataFT>,
        moduleUNI_AO1: WidgetOutputB,
        moduleUNI2_label: TextWidget<DataFT>,
        moduleUNI2_AO1: WidgetOutputB,
    },
    info: {
