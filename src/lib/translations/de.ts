...
//     warrantyNr: t`Garantie für die Wärmepumpe ${'n'} (${'cislo'})`,
...
//     yearlyHPCheckNr: t`Jährliche Überprüfung der Wärmepumpe ${0}`,
//     yearlyCheckTitle: `Aufgabenbeschreibung bei Durchführung der jährlichen vorbeugenden Inspektion der Luft-Wärmepumpe`,
//     doYearlyCheckNr: t`Jährliche Überprüfung der Wärmepumpe ${'n'} durchführen`,
//     filledYearlyCheckNr: t`Durchgeführte jährliche Überprüfung der Wärmepumpe ${'n'} (${'cislo'})`,
