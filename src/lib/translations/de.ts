...
const de: PlainTranslations = {
    ...
    longAppName: `Verwaltung der IR-Regler`,
    appName: `Reglerverwaltung IR`,
    ...
    doYouWantRemoteAccess: `Möchten Sie Fernzugriff auf den Regler einrichten?`,
    whoHasAccess: `Wer wird Zugriff darauf haben?`,
    endCustomer: `Endkunde`,
    commissioningCompany: `Inbetriebnahme-Firma`,
    whoWillBeInvoiced: `Wem wird der Fernzugriff in Rechnung gestellt? (einmaliger Preis 1.000 CZK inkl. MwSt.)`,
...
<p>Reglerverwaltung IR</p>`,
    ...
    agreeWIthRRPrice: `Ich stimme dem einmaligen Preis von 1.000 CZK inklusive MwSt. für diese Dienstleistung zu.`,
    suits: `entspricht`,
    ...
    characteristicsAndSizeOfIndoorUnit: `Charakteristik und Größe des Innengerät`,
    ...
    collectorDescription: `Beschreibung`,
