...
export default {
    ...
    pdf: {
        ...
        previewNotAvaiable: t`Náhled dokumentu nyní není možné zobrazit. Prosím, opravte všechny chyby ve formuláři. Chybná pole: ${'fields'}`,
    },
    search: {
...
<p>Evidence IR</p>`,
    ...
    rk: {
        ...
        note: `Poznámka`,
        recommendations: {
            settingsTitle: `Upozorňování na roční kontroly`,
            userWantsTo: `Koncoový zákazník chce být upozorňován přes email na blížící se čas objednání roční kontroly TČ`,
            ...
            text: `Chcete zažádat o roční kontrolu tepelného čerpadla?`,
            name: t`Jméno: ${'name'}`,
            location: t`Místo instalace: ${'location'}`,
            executedBy: t`Kontrolu provede: ${'company'}`,
            requestSent: `Žádost odeslána.`,
            youCanCloseThisTab: `Nyní můžete tuto kartu zavřít`,
            sending: `Odesílání…`,
            companyWillContactYou: t`${'company'} Vás brzy kontaktuje ohledně podrobností provedení kontroly.`,
            request: `Nezávazně zažádat`,
