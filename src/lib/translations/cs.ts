...
<p>Evidence IR</p>`,
    ...
    isAdditionalHeatingSourceConnected: `Je v systému připojen doplňkový zdroj topení?`,
    typeAndPowerOfAdditionalHeatingSource: `Typ a výkon doplňkového zdroje pro topení`,
    doesHeatPumpPrepareHotWater: `Připravuje TČ teplou vodu?`,
    ...
    isPoolHeatingManagedByHeatPump: `Je také řešen prostřednictvím tepelného čerpadla ohřev bazénu?`,
    ...
    wasPrimaryCircuitTested: `Bylo provedeno řádné odvzdušení a tlaková zkouška primárního okruhu?`,
    commissioningSteps: `Informace o krocích provedených v průběhu uvádění do provozu`,
    wasInstallationAccordingToManual: `Byla instalace a uvedení do provozu tepelného čerpadla provedena dle podmínek uvedených v návodu na montáž, připojení a obsluhu, instalačních podmínek a obecně platných norem?`,
    wasControllerSetToParameters: `Byl nastaven regulátor tep. čerpadla na předepsané parametry?`,
    wasOwnerFamiliarizedWithFunction: `Byl vlastník nebo provozovatel seznámen se základní funkcí tep. čerpadla a jeho obsluhou?`,
    ...
    isInstallationInWarrantyConditions: `Je instalace a uvedení do provozu v souladu s podmínkami prodloužené záruky?`,
}